...
import com.basco.service.TagService;
...
public class BlogController {
    ...
    private static final String INPUT = "admin/blog-admin-publish";
    private static final String LIST = "admin/blog-admin-list";
    ...
    public String search(@PageableDefault(size = 2,sort = {"updateTime"},direction = Sort.Direction.DESC) Pageable pageable,
                         BlogQuery blog, Model model){
        model.addAttribute("page",blogService.listBlog(pageable,blog));
        return "admin/blog-admin-list :: blogList";
    }
    ...
    public String input(Model model){
        ...
        return "admin/blog-admin-publish";
    }
